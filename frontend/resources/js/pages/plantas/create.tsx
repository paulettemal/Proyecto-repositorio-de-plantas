...
export default function CreatePlanta() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            setErrors(error.response?.data?.errors || { general: 'Error al crear la planta' });
        } finally {
            setProcessing(false);
        }
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Helmet>
                <title>Nueva Planta - Repositorio de Plantas</title>
            </Helmet>
